...
* I also created and stated empty ANALYSIS.md and DONE.md files. First in the project; AI fills the ANALYSIS.md file with the phases of project to handle one by one by reading the RULES.md file.,
