...
> CMD: `npm install -g @anthropic-ai/claude-code`__
> CMD: `Set-ExecutionPolicy -ExecutionPolicy RemoteSigned -Scope CurrentUser`__
> CMD: `claude --dangerously-skip-permissions`__
or__
