...
public class SellerApplicationController {
	...
	public ResponseEntity<SellerApplicationResponse> me(Authentication authentication) {
		return sellerApplicationService.findLatestForAppUser(authentication.getName())
