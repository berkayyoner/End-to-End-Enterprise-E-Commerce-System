...
import { listUserLogs } from '../api/logsApi'
...
export function UserLogsPage() {
  ...
  const loadLogs = useCallback(async (pageNum = 0) => {
    ...
    setError(null)
    try {
      const data = await listUserLogs(pageNum, pageSize)
  ...
  return (
    <div className="logs-container">
      ...
      {loading ? (
        ...
        <div className="empty-message">{t('userLogs.emptyList')}</div>
      ) : (
        <>
